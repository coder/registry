...
| Bring-your-own binary                              |      6 | A documented way to disable download or install entirely when the tool is already baked into the image                                                                                                                                                                                          |
| Egress transparency                                |      4 | A dedicated README section enumerates the external endpoints contacted at install and runtime, with notes for restricted or air-gapped environments. Mentions scattered across unrelated examples earn at most half; inferable endpoints do not count                                           |
