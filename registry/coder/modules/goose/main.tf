...
module "agentapi" {
  # TODO: how to reference the agentapi module? We need version pinning.
  # while the PR is in review, you can reference the module like this:
  # source = "git::https://github.com/coder/registry.git//registry/coder/modules/agentapi?ref=hugodutka/agentapi-module"
  source = "../agentapi"
